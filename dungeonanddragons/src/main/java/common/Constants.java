...
/**
 * Created by Adam And Lauren on 6/8/2015.
 */
public class Constants {
    ...
    public static String DamageImmunities = "Damage Immunities";
    public static String ConditionImmunities = "Condition Immunities";
