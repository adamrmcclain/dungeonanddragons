...
public class ProcessMonstersTest extends TestCase {
    ...
    public void testGetMonsterList() throws Exception {
        ...
        Monsters monsters1 = jsonUtils.mapJsonToMonster(jsonUtils.getJsonNodeFromString(monsters.toString()));
    ...
    public void testAddAttributesToJson(){
        ...
        JsonUtils jsonUtils = new JsonUtils();
        Monsters monsters1 = jsonUtils.mapJsonToMonster(jsonUtils.getJsonNodeFromString(root.toString()));
